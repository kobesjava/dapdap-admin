...
export interface Network__GetListInput {
  skip?: number;
  take?: number;
}
export interface Network__GetListResponseData {
  data?: {
    id?: number;
    chain_id?: number;
    name?: string;
...
export interface Network__CreateOneInput {
  chain_id: number;
  name: string;
  technology?: string;
  description?: string;
...
export interface Network__CreateOneResponseData {
  data?: {
    id?: number;
  };
}

export interface Netwok__DeleteManyInput {
  ids: {}[];
}
export interface Netwok__DeleteManyResponseData {
  data?: {
    count?: number;
  };
}

export interface Dapp__GetListInput {
  skip?: number;
  take?: number;
}
export interface Dapp__GetListResponseData {
  data?: {
    id?: number;
    name?: string;
    description?: string;
...
export interface Dapp__DeleteManyInput {
  ids: {}[];
}
export interface Dapp__DeleteManyResponseData {
  data?: {
    count?: number;
  };
}

export interface Dapp__GetCategoryListResponseData {
  data?: {
    id?: number;
    name?: string;
  }[];
...
export interface Dapp__DeleteManyCategoryInput {
  ids: {}[];
}
export interface Dapp__DeleteManyCategoryResponseData {
  data?: {
    count?: number;
  };
}

export interface Dapp__CreateOneInput {
  name: string;
  description?: string;
  native_token?: string;
  recommend?: boolean;
...
export interface Dapp__GetOneInput {
  id: number;
}
export interface Dapp__GetOneResponseData {
  data?: {
    id?: number;
    name?: string;
    description?: string;
...
export interface Network__GetOneInput {
  id: number;
}
export interface Network__GetOneResponseData {
  data?: {
    id?: number;
    chain_id?: number;
    name?: string;
